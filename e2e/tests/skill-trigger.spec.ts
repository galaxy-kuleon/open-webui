...
/** Test PDF files */
const TEST_PDF_EN_PATH = '/Users/noelbao/Works/glm-ocr-latest-test/contract_en3.pdf' as const;
const TEST_PDF_ZH_PATH = '/Users/noelbao/Works/glm-ocr-latest-test/contract_zh3.pdf' as const;
...
test.describe('Skill Trigger', () => {
	...
	test('can upload an English PDF and trigger the anything-to-docx skill', async ({ page }) => {
		// Step 1: Log in
		await login(page);
	...
	test('can upload a Chinese PDF and trigger the anything-to-docx skill', async ({ page }) => {
		// Step 1: Log in
		await login(page);
