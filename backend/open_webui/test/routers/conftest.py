...
_test_data_dir = tempfile.mkdtemp(prefix='owui_routers_test_')

os.environ.setdefault('DATA_DIR', _test_data_dir)
os.environ.setdefault('DATABASE_URL', f'sqlite:///{_test_data_dir}/test.db')
os.environ.setdefault('WEBUI_SECRET_KEY', 'test-secret-key-for-routers-tests')
