...
def build_loader_from_config(request):
    ...
    return Loader(
        ...
        # KG1 (GLM-OCR) settings — HERMES-HOOK-KG1-LOADER-BEGIN
        KG1_GLMOCR_PROJECT_DIR=config.KG1_GLMOCR_PROJECT_DIR,
        KG1_OLLAMA_HOST=config.KG1_OLLAMA_HOST,
        KG1_OLLAMA_PORT=config.KG1_OLLAMA_PORT,
        KG1_LAYOUT_DEVICE=config.KG1_LAYOUT_DEVICE,
        KG1_SOFFICE_PATH=config.KG1_SOFFICE_PATH,
        KG1_TIMEOUT=config.KG1_TIMEOUT,
        KG1_GLM_OCR_CONCURRENCY=config.KG1_GLM_OCR_CONCURRENCY,
